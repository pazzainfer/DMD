 ...
 * 2012-8-16 ����12:55:45
 */
public class CustomPaletteComposite  extends Composite {
	...
	private String paletteTitle = GEFMessages.Palette_Label;
	private Image titleIcon = InternalImages.get(InternalImages.IMG_PALETTE);
	 ...
	 * @param pvProvider
	 * @param preferences
	 * @param paletteTitle ���������(���Ϊnull,��ʹ��Ĭ�ϱ���)
	 * @param titleIcon ���������ͼ��(���Ϊnull,��ʹ��Ĭ��ͼ��)
	 */
	public CustomPaletteComposite(Composite parent, int style,
			IWorkbenchPage page, PaletteViewerProvider pvProvider,
			FlyoutPreferences preferences,String paletteTitle,Image titleIcon) {
	...
	private class ResizeAction extends Action {
		...
		public void run() {
			final Tracker tracker = new Tracker(CustomPaletteComposite.this,
					SWT.RIGHT | SWT.LEFT);
	...
	private class TitleDragManager extends MouseAdapter implements Listener,
		...
		public void handleEvent(Event event) {
			...
			threshold = dock == PositionConstants.EAST ? Integer.MAX_VALUE / 2
					: -1;
			final Composite flyout = CustomPaletteComposite.this;
						...
						public void run() {
							...
							if (!switchDock)
								invalid = !isDescendantOf(
										CustomPaletteComposite.this, ctrl);
							if (switchDock) {
								if (dock == PositionConstants.WEST) {
	...
	private class TitleCanvas extends Canvas {
		...
		private void init(boolean isHorizontal) {
			final IFigure contents = new TitleLabel(true,CustomPaletteComposite.this.paletteTitle,
					CustomPaletteComposite.this.titleIcon);
		...
		public void setFont(Font font) {
			...
			if (isVisible()) {
				 ...
				 * getParent().layout().
				 */
				CustomPaletteComposite.this.layout(true);
