 ...
 */
public class RelationshipReconnectPrimaryKeyCommand extends Command {
	...
	public RelationshipReconnectPrimaryKeyCommand() {
		super(Messages.RelationshipReconnectPrimaryKeyCommand_0);
	}
